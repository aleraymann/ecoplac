    ...
    <div class="container">
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div id="plastificado_extra" class="panel-collapse collapse" role="tabpanel"
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 ">
                                <label class="descricao_produto">
                                    Recomendado para fôrmas de concreto aparente, divisórias, alojamentos temporários,
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <p>– Canteiros de obras e outras diversas situações onde podem haver o contato com
                                        umidade</p>
                                </div>
                            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="resinado_wbp" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <div id="resinado_mr" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 ">
                                <label class="descricao_produto">
                                    Recomendado para uso interno ou utilizações rápidas em fôrmas de concreto, tapumes,
