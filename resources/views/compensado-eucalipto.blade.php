                ...
                <a class="card-segmentos">
                    ...
                    <div class="back-segmentos">
                        ...
                        <p class="sub-title_produtos">O Compensado Eucalipto é um painel multilaminado e prensado
                            ...
                            <p class="sub-title_produtos">Oferecendo uma textura fina e tonalidade clara, o compensado
                                eucalipto tem a
                ...
                <a class="card-segmentos">
                    ...
                    <div class="back-segmentos">
                        ...
                        <p class="sub-title_produtos">A aplicação do Compensado Eucalipto, é utilizado na indústria
                            ...
                            <p class="sub-title_produtos">Ele também é utilizado para fechamento de obras e formas de
                                concreto não aparente,
                                já que neste tipo de compensado pode ser utilizada a cola do tipo WBP – weather and boil
                                proof, tornando a
...
<section class="content">
    <div class="parallax_claro">
        <div class="conteudo">
            ...
            <p class="sub-title4">
                <b>À prova d'água:</b> quando utilizada a cola tipo WBP, o Compensado Eucalipto apresenta alta
                resistência à
                água e ambientes úmidos.
            </p>
            <p class="sub-title4">
                <b>Produto ecológico: </b> oriundo de madeiras 100% reflorestadas, o compensado Eucalipto é ecológico e
                não
