            ...
            <div class="courses ">
                <div class="course card1" tabindex="1">
                    <div class="course-info">
                        <h5 class="title_produtos">O que é o Madeirite Resinado MR (Cola Branca)?</h5>
                    </div>
                    <div class="course-more">
                        <div class="conteudo_card">
                            <p class="sub-title_produtos">O Madeirite Resinado MR são chapas compostas por lâminas de
                                madeira sobrepostas em
                                camadas, coladas com resina MR reutilizável PARMACOL UF 1408, que é uma cola à base de
                                uréia e formol,
                                também conhecida por cola branca.
                            </p>
                            <p class="sub-title_produtos">Esta cola não oferece resistência à água, por isso, o uso
                                deste tipo de madeira é
                                recomendado em áreas internas, com pouca ou nenhuma exposição à umidade.
                            </p>
                            <p class="sub-title_produtos">O nosso compensado Resinado MR (cola branca) é produzido com
                                lâminas rigorosamente
                                selecionadas, todas originadas de reflorestamento, e apesar de não ser à prova d’água,
                                ele alcança a
                ...
                <div class="course card1" tabindex="1">
                    <div class="course-info">
                        <h5 class="title_produtos">Onde o Madeirite Resinado MR é utilizado?</h5>
                    </div>
                    <div class="course-more">
                        <div class="conteudo_card">
                            <p class="sub-title_produtos">O Madeirite Resinado MR é indicado no uso interno da
                                construção civil, em
                                edificações no sistema a seco ou em qualquer área que não exija o uso de água ou outros
                                materiais
                                úmidos.

                            </p>
                            <p class="sub-title_produtos">Ele também é utilizado na fabricação de móveis, prateleiras,
                                pisos, forrações,
                                repartições, revestimentos, embalagens, caixas, tapumes, fôrmas de concreto não
                                aparentes, entre outros.
                            </p>
    ...
    <div class="parallax_claro">
        <div class="conteudo">
            ...
            <<p class="sub-title4">
                ...
                <p class="sub-title4">
                    <b>Resistência: </b> embora não seja resistente à água, o Madeirite Resinado MR oferece alta
                    resistência
