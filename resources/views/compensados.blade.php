    ...
    <div class="container">
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
                ...
                <div id="industrial" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 ">
                                <label class="descricao_produto">
                                    O compensado industrial é um painel multilaminado de fácil manuseio. Suas faces são
                                    reparadas e lixadas para um melhor acabamento. Indicado para fabricação de móveis em
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#pinus"
                            aria-expanded="false" aria-controls="pinus">
                ...
                <div id="pinus" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 ">
                                <label class="descricao_produto">
                                    O compensado embalagem é um painel cujas faces não recebem acabamento. Recomendado
                ...
                <div id="parica" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 ">
                                <label class="descricao_produto">
                                    A virola é uma madeira branca de superfície lisa com resistência à umidade, indicada
