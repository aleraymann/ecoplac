        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 ">
                                <label class="descricao_produto">
                                    O pontalete, conhecido também como “escora”, é muito utilizado na construção civil,
            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingTwo">
                    <h4 class="panel-title">
                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#ripa"
                            aria-expanded="false" aria-controls="ripa">
                            Ripa
                        </a>
                    </h4>
                </div>
