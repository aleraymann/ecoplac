...
<section class="content">
    ...
    <div class="conteudo">
        ...
        <p class="sub-title_produtos">O Compensado Moveleiro Virola Paricá é um produto leve e ao mesmo tempo
            resistente, e apresenta um excelente acabamento, mesmo aos mais exigentes, e proporciona uma ampla
            utilização, devido às suas vantagens.

        </p>
        <p class="sub-title_produtos">É composto de camadas de lâminas de madeira torneada, sobrepostas e coladas com
            resina fenólica WBP 100% à prova d'água, é caracterizado por ser um produto mais leve que o compensado de
            amescla e seu acabamento do mais alto padrão de qualidade. Variadas formas de utilização que o produto
            oferece. Recomendado para indústria moveleira, forração de ambientes e usos em geral
        </p>

        <div class="title_produtos_2">Onde o Compensado Moveleiro Virola Paricá é utilizado </div>
        <p class="sub-title_produtos">A aplicação do Compensado Moveleiro Virola Paricá, como o próprio nome já indica,
...
<section class="content">
    ...
    <div class="conteudo">
        ...
        <p class="sub-title4">
            <b>À prova d'água:</b>  quando utilizada a cola tipo WBP, o Compensado Moveleiro Virola Paricá apresenta alta resistência à água e ambientes úmidos.
        </p>
        <p class="sub-title4">
            <b>Produto ecológico: </b>  quando utilizada a cola tipo WBP, o Compensado Moveleiro Virola Paricá apresenta alta resistência à água e ambientes úmidos.
        </p>
        <p class="sub-title4">
            <b>Resistência:</b> quando utilizada a cola tipo WBP, o Compensado Moveleiro Virola Paricá apresenta alta resistência à água e ambientes úmidos.

        </p>
        <p class="sub-title4">
            <b>Praticidade:</b> o Compensado Moveleiro Virola Paricá tem como uma de suas principais vantagens a facilidade de manuseio e também a logística para transportá-lo
