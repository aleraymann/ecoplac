                    ...
                    <div class="back-segmentos">
                        <div>
                            <p class="sub-title_produtos">O madeirite plastificado é a chapa multilaminada, que é
                                prensada
                                com resina
                                fenólica(WBP), e recebe em sua capa uma densa camada de película, ou papel fenólico com
                                a
                                gramatura 120gr/m2
                                na cor marrom e liso. Os painéis são produzidos de forma que as fibras se cruzem,
                                formando
                                uma chapa
                                extremamente resistente.
                            </p>
                            <p class="sub-title_produtos">As bordas do Madeirite Plastificado são seladas com tinta para
                                minimizar a
                                penetração de umidade, e por isso, resistem a água fria, quente, ao vapor, e quaisquer
                    ...
                    <div class="back-segmentos">
                        <div>
                            <p class="sub-title_produtos">O madeirite Plastificado é a escolha ideal para o ramo de
                                ...
                                e
                                andaimes, para
                                uso em fôrmas de concreto aparente, formas para a concretagem com ou sem suporte
                                metálico,
                                divisórias,
...
<section class="content">
    <div class="parallax_claro">
        <div class="conteudo">
            ...
            <p class="sub-title4">
                <b>Custo-benefício:</b> em comparação com as formas de alumínio, o madeirite plastificado traz mais
                economia
            </p>
            <p class="sub-title4">
