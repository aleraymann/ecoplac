                ...
                <a class="card-segmentos">
                    ...
                    <div class="back-segmentos">
                        ...
                        <p class="sub-title_produtos">O Compensado Pinus Industrial é um painel multilaminado,
                                ...
                                utilizados em exteriores, se aplicado cola com característica WBP (weather and boil
                                proof), ou em interiores
                                e locais de baixa exposição à umidade, desde que utilizado cola branca.
                            </p>
                            <p class="sub-title_produtos">A madeira proveniente de pinus é amplamente utilizada em
                                reflorestamento no
                                Brasil, devido ao seu rápido crescimento. Com isso, o reflorestamento é feito de forma
                                rápida, e não há
                ...
                <a class="card-segmentos">
                    ...
                    <div class="back-segmentos">
                        ...
                        <p class="sub-title_produtos">A aplicação do Compensado Pinus Industrial se dá em assoalhos
                            ...
                            <p class="sub-title_produtos">Ele Ele também pode ser utilizado na fabricação de móveis em
                                geral, como estantes,
                                prateleiras, balcões, gavetas, estofados, armários, divisórias, pisos para feiras e
                                mezaninos.
...
<section class="content">
    <div class="parallax_claro">
        <div class="conteudo">
            ...
            <p class="sub-title4">
                <b>À prova d'água:</b> quando utilizada a cola tipo WBP, o Compensado Industrial apresenta alta
                resistência à
                água e ambientes úmidos.
            </p>
            <p class="sub-title4">
                <b>Produto ecológico: </b> oriundo de madeiras 100% reflorestadas, o compensado pinus industrial é
                ecológico
            ...
            <p class="sub-title4">
                <b>Praticidade:</b> Compensado Industrial tem como uma de suas principais vantagens a facilidade de
                manuseio
...
<section class="content">
    ...
    <p class="sub-title2">Fale com nossos especialistas e esclareça todas as suas dúvidas sobre o Compensado Industrial,
